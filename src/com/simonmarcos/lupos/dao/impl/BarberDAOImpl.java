...
public class BarberDAOImpl implements DAOBarber {
    ...
    public int save(Barber o) {
        ...
        if (!lista.contains(o)) {
            ...
            if (c != null) {
                ...
                String consultaSQL = "INSERT INTO Barber (idBarber,name,lastName,dni,phone,dateEntry,address) VALUES (?,?,?,?,?,?,?)";
    ...
    public List<Barber> queryFilter(int code, String name) {
        ...
        if (c != null) {
            try {
                String consultaSQL = "SELECT idBarber,name,lastName,dni,phone,dateEntry,address FROM Barber WHERE dni = ?";
    ...
    public int modificar(int code, Barber o) {
        ...
        if (c != null) {
            try {
                String consultaSQL = "UPDATE Barber SET name = ?, lastName = ?, dni = ?,phone = ?,dateEntry = ?, address = ? WHERE dni = ?";
                PreparedStatement ps = c.prepareStatement(consultaSQL);
    ...
    public List<Barber> toList() {
        ...
        if (c != null) {
            try {
                String consultaSQL = "SELECT idBarber,name,lastName,dni,phone,dateEntry,address FROM Barber";
